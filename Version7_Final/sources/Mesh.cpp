...
void Mesh::drawMesh(Shader& shader, Transform transform, Material material) {
	//applyTransform(transform);
	//std::cout << glm::to_string(transform.transformMat) << std::endl;
	...
	//// stari nacin prosljedivanja uniformnih varijabli
	...
	// novi nacin prosljedivanja uniformnih varijabli
	shader.setUniformVec3("ambient", material.ambient);
	shader.setUniformVec3("diffuse", material.diffuse);
	shader.setUniformVec3("specular", material.specular);
